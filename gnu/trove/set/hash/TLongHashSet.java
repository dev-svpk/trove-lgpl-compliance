...
public class TLongHashSet extends TLongHash implements gnu.trove.set.TLongSet, Externalizable {
   ...
   public final boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.set.TLongSet)) {
         return false;
      } else {
         gnu.trove.set.TLongSet var3;
         if ((var3 = (gnu.trove.set.TLongSet)var1).size() != this.size()) {
            return false;
         } else {
   ...
   public final void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TLongHashSet.class.getName()).log(Level.SEVERE, null, ex);
       }
