...
public class TDoubleLongHashMap extends TDoubleLongHash implements TDoubleLongMap, Externalizable {
   ...
   public boolean forEachKey(gnu.trove.procedure.TDoubleProcedure var1) {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TDoubleLongProcedure var1) {
      byte[] var2 = this._states;
      double[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TDoubleLongProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TDoubleLongMap)) {
         ...
         TDoubleLongMap var16;
         if ((var16 = (TDoubleLongMap)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
