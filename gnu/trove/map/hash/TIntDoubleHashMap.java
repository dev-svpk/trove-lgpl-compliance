...
public class TIntDoubleHashMap extends TIntDoubleHash implements TIntDoubleMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TIntDoubleProcedure var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      double[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TIntDoubleProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntDoubleMap)) {
         ...
         TIntDoubleMap var15;
         if ((var15 = (TIntDoubleMap)var1).size() != this.size()) {
            return false;
         } else {
            double[] var2 = this._values;
            byte[] var3 = this._states;
