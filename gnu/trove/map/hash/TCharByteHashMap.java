...
public class TCharByteHashMap extends TCharByteHash implements gnu.trove.map.TCharByteMap, Externalizable {
   ...
   public TCharByteHashMap(gnu.trove.map.TCharByteMap var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.TCharByteMap var1) {
      this.ensureCapacity(var1.size());
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.TCharByteMap)) {
         return false;
      } else {
         gnu.trove.map.TCharByteMap var9;
         if ((var9 = (gnu.trove.map.TCharByteMap)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
