...
public class TDoubleCharHashMap$TKeyView implements TDoubleSet {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleCharHashMap$TDoubleCharKeyHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleCharHashMap.access$0(this.this$0);
   }

   public int size() {
      return TDoubleCharHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TDoubleCharHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(double var1) {
      return TDoubleCharHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TDoubleCharHashMap$TKeyView$1(this, var1));
      var1.append("}");
