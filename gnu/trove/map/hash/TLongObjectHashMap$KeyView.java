...
class TLongObjectHashMap$KeyView implements TLongSet {
   // $FF: synthetic field
   ...
   public int size() {
      return TLongObjectHashMap.access$0(this.this$0);
   }

   public boolean isEmpty() {
      return TLongObjectHashMap.access$0(this.this$0) == 0;
   }
   ...
   public boolean containsAll(Collection var1) {
      ...
      while(var2.hasNext()) {
         ...
         if (!this.this$0.containsKey((Long)var3)) {
            return false;
         }
      }
