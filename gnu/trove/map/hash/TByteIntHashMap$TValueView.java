...
public class TByteIntHashMap$TValueView implements TIntCollection {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TByteIntHashMap$TByteIntValueHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TByteIntHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TByteIntHashMap$TValueView$1(this, var1));
      var1.append("}");
