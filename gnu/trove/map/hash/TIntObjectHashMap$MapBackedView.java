...
abstract class TIntObjectHashMap$MapBackedView extends AbstractSet implements Iterable, Set {
   // $FF: synthetic field
   ...
   // $FF: synthetic method
   TIntObjectHashMap$MapBackedView(TIntObjectHashMap var1, TIntObjectHashMap$MapBackedView var2) {
      this(var1);
   }
}
