...
public class TByteLongHashMap$TValueView implements TLongCollection {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TByteLongHashMap$TByteLongValueHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TByteLongHashMap.access$2(this.this$0);
   }

   public int size() {
      return TByteLongHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TByteLongHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(long var1) {
      ...
      } while(var4[var5] == 0 || var4[var5] == 2 || var1 != var3[var5]);
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TByteLongHashMap$TValueView$1(this, var1));
      var1.append("}");
