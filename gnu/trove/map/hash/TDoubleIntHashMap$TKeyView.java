...
public class TDoubleIntHashMap$TKeyView implements TDoubleSet {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleIntHashMap$TDoubleIntKeyHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleIntHashMap.access$0(this.this$0);
   }

   public int size() {
      return TDoubleIntHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TDoubleIntHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(double var1) {
      return TDoubleIntHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TDoubleIntHashMap$TKeyView$1(this, var1));
      var1.append("}");
