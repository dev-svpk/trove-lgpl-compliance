...
public class TFloatCharHashMap$TValueView implements TCharCollection {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TFloatCharHashMap$TFloatCharValueHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TFloatCharHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatCharHashMap$TValueView$1(this, var1));
      var1.append("}");
