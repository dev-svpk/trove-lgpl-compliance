...
public class TFloatFloatHashMap$TValueView implements TFloatCollection {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TFloatFloatHashMap$TFloatFloatValueHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TFloatFloatHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatFloatHashMap$TValueView$1(this, var1));
      var1.append("}");
