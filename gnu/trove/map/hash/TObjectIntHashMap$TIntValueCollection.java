...
class TObjectIntHashMap$TIntValueCollection implements TIntCollection {
   // $FF: synthetic field
   ...
   public boolean remove(int var1) {
      ...
      } while(var3[var4] == TObjectIntHashMap.FREE || var3[var4] == TObjectIntHashMap.REMOVED || var1 != var2[var4]);
   ...
   public boolean retainAll(int[] var1) {
      ...
      while(var5-- > 0) {
         if (var4[var5] != TObjectIntHashMap.FREE && var4[var5] != TObjectIntHashMap.REMOVED && Arrays.binarySearch(var1, var3[var5]) < 0) {
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TObjectIntHashMap$TIntValueCollection$1(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static TObjectIntHashMap access$0(TObjectIntHashMap$TIntValueCollection var0) {
      return var0.this$0;
   }
}
