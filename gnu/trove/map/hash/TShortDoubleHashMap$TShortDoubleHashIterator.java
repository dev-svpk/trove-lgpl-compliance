...
class TShortDoubleHashMap$TShortDoubleHashIterator extends THashPrimitiveIterator implements TShortDoubleIterator {
   // $FF: synthetic field
   final TShortDoubleHashMap this$0;

   TShortDoubleHashMap$TShortDoubleHashIterator(TShortDoubleHashMap var1, TShortDoubleHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
