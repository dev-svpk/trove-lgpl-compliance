...
public class TIntShortHashMap$TValueView implements TShortCollection {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TIntShortHashMap$TIntShortValueHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TIntShortHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntShortHashMap$TValueView$1(this, var1));
      var1.append("}");
