...
public class TByteFloatHashMap$TValueView implements TFloatCollection {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TByteFloatHashMap$TByteFloatValueHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TByteFloatHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TByteFloatHashMap$TValueView$1(this, var1));
      var1.append("}");
