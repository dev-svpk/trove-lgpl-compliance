...
public class TIntDoubleHashMap$TKeyView implements TIntSet {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntDoubleHashMap$TIntDoubleKeyHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TIntDoubleHashMap.access$0(this.this$0);
   }

   public int size() {
      return TIntDoubleHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TIntDoubleHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(int var1) {
      return TIntDoubleHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public boolean containsAll(gnu.trove.TIntCollection var1) {
   ...
   public boolean addAll(gnu.trove.TIntCollection var1) {
      throw new UnsupportedOperationException();
   }
   ...
   public boolean retainAll(gnu.trove.TIntCollection var1) {
      if (this == var1) {
         return false;
      } else {
         boolean var2 = false;
   ...
   public boolean removeAll(gnu.trove.TIntCollection var1) {
      if (this == var1) {
         this.clear();
         return true;
      } else {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntSet)) {
         ...
         TIntSet var3;
         if ((var3 = (TIntSet)var1).size() != this.size()) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TIntDoubleHashMap$TKeyView$1(this, var1));
      var1.append("}");
