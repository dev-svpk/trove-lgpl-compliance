...
public class TByteIntHashMap$TKeyView implements TByteSet {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteIntHashMap$TByteIntKeyHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteIntHashMap.access$0(this.this$0);
   }

   public int size() {
      return TByteIntHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TByteIntHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(byte var1) {
      return TByteIntHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TByteIntHashMap$TKeyView$1(this, var1));
      var1.append("}");
