...
public class TByteDoubleHashMap extends TByteDoubleHash implements gnu.trove.map.TByteDoubleMap, Externalizable {
   ...
   public TByteDoubleHashMap(gnu.trove.map.TByteDoubleMap var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.TByteDoubleMap var1) {
      this.ensureCapacity(var1.size());
   ...
   public boolean forEachEntry(gnu.trove.procedure.TByteDoubleProcedure var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      double[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TByteDoubleProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.TByteDoubleMap)) {
         return false;
      } else {
         gnu.trove.map.TByteDoubleMap var15;
         if ((var15 = (gnu.trove.map.TByteDoubleMap)var1).size() != this.size()) {
            return false;
         } else {
            double[] var2 = this._values;
            byte[] var3 = this._states;
