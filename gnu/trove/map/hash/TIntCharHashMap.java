...
public class TIntCharHashMap extends TIntCharHash implements TIntCharMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TIntCharProcedure var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      char[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TIntCharProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntCharMap)) {
         ...
         TIntCharMap var9;
         if ((var9 = (TIntCharMap)var1).size() != this.size()) {
            return false;
         } else {
            char[] var2 = this._values;
            byte[] var3 = this._states;
