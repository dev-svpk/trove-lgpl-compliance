...
public class TFloatIntHashMap$TKeyView implements TFloatSet {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TFloatIntHashMap$TFloatIntKeyHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TFloatIntHashMap.access$0(this.this$0);
   }

   public int size() {
      return TFloatIntHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TFloatIntHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(float var1) {
      return TFloatIntHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TFloatIntHashMap$TKeyView$1(this, var1));
      var1.append("}");
