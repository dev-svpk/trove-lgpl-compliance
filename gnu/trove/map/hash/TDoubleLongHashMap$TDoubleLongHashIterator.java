...
class TDoubleLongHashMap$TDoubleLongHashIterator extends THashPrimitiveIterator implements TDoubleLongIterator {
   // $FF: synthetic field
   final TDoubleLongHashMap this$0;

   TDoubleLongHashMap$TDoubleLongHashIterator(TDoubleLongHashMap var1, TDoubleLongHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
