...
public class TByteShortHashMap extends TByteShortHash implements gnu.trove.map.TByteShortMap, Externalizable {
   ...
   public TByteShortHashMap(gnu.trove.map.TByteShortMap var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.TByteShortMap var1) {
      this.ensureCapacity(var1.size());
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.TByteShortMap)) {
         return false;
      } else {
         gnu.trove.map.TByteShortMap var9;
         if ((var9 = (gnu.trove.map.TByteShortMap)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
