...
public class TCharIntHashMap extends TCharIntHash implements TCharIntMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TCharIntProcedure var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TCharIntProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharIntMap)) {
         ...
         TCharIntMap var9;
         if ((var9 = (TCharIntMap)var1).size() != this.size()) {
            return false;
         } else {
            int[] var2 = this._values;
            byte[] var3 = this._states;
