...
public class TDoubleDoubleHashMap$TValueView implements TDoubleCollection {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleDoubleHashMap$TDoubleDoubleValueHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleDoubleHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TDoubleDoubleHashMap$TValueView$1(this, var1));
      var1.append("}");
