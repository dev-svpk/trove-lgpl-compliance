...
public class TShortDoubleHashMap$TKeyView implements TShortSet {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortDoubleHashMap$TShortDoubleKeyHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortDoubleHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(short var1) {
      return TShortDoubleHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TShortDoubleHashMap$TKeyView$1(this, var1));
      var1.append("}");
