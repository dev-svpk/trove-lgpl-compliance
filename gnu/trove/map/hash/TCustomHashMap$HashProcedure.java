...
final class TCustomHashMap$HashProcedure implements TObjectObjectProcedure {
   private int h;
   // $FF: synthetic field
   ...
   // $FF: synthetic method
   TCustomHashMap$HashProcedure(TCustomHashMap var1, TCustomHashMap$HashProcedure var2) {
      this(var1);
   }
}
