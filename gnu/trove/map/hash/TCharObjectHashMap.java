...
public class TCharObjectHashMap extends TCharHash implements TCharObjectMap, Externalizable {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharObjectMap)) {
         ...
         TCharObjectMap var6;
         if ((var6 = (TCharObjectMap)var1).size() != this.size()) {
            return false;
         } else {
            try {
               TCharObjectIterator var2 = this.iterator();
   ...
   public int hashCode() {
      ...
      while(var4-- > 0) {
         if (var3[var4] == 1) {
            var1 += gnu.trove.impl.HashFunctions.hash(this._set[var4]) ^ (var2[var4] == null ? 0 : var2[var4].hashCode());
         }
      }
