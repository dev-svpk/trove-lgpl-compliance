...
public class TFloatShortHashMap$TValueView implements TShortCollection {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TFloatShortHashMap$TFloatShortValueHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TFloatShortHashMap.access$2(this.this$0);
   }
   ...
   public boolean remove(short var1) {
      ...
      } while(var3[var4] == 0.0F || var3[var4] == 2.0F || var1 != var2[var4]);
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatShortHashMap$TValueView$1(this, var1));
      var1.append("}");
