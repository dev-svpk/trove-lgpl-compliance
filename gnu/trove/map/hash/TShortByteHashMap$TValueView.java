...
public class TShortByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TShortByteHashMap$TShortByteValueHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TShortByteHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TShortByteHashMap$TValueView$1(this, var1));
      var1.append("}");
