...
class TIntFloatHashMap$TIntFloatHashIterator extends THashPrimitiveIterator implements TIntFloatIterator {
   // $FF: synthetic field
   final TIntFloatHashMap this$0;

   TIntFloatHashMap$TIntFloatHashIterator(TIntFloatHashMap var1, TIntFloatHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
