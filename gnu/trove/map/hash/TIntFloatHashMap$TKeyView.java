...
public class TIntFloatHashMap$TKeyView implements TIntSet {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntFloatHashMap$TIntFloatKeyHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TIntFloatHashMap.access$0(this.this$0);
   }

   public int size() {
      return TIntFloatHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TIntFloatHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(int var1) {
      return TIntFloatHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TIntFloatHashMap$TKeyView$1(this, var1));
      var1.append("}");
