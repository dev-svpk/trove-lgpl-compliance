...
public class TDoubleFloatHashMap$TValueView implements TFloatCollection {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TDoubleFloatHashMap$TDoubleFloatValueHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TDoubleFloatHashMap.access$2(this.this$0);
   }
   ...
   public boolean remove(float var1) {
      ...
      } while(var3[var4] == 0.0D || var3[var4] == 2.0D || var1 != var2[var4]);
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TDoubleFloatHashMap$TValueView$1(this, var1));
      var1.append("}");
