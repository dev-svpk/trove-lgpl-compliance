...
public class TDoubleByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TDoubleByteHashMap$TDoubleByteValueHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TDoubleByteHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TDoubleByteHashMap$TValueView$1(this, var1));
      var1.append("}");
