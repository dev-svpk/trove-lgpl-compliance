...
public class TLongCharHashMap$TValueView implements TCharCollection {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TLongCharHashMap$TLongCharValueHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TLongCharHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TLongCharHashMap$TValueView$1(this, var1));
      var1.append("}");
