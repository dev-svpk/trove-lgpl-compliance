...
public class TShortLongHashMap$TKeyView implements TShortSet {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortLongHashMap$TShortLongKeyHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortLongHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(short var1) {
      return TShortLongHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TShortLongHashMap$TKeyView$1(this, var1));
      var1.append("}");
