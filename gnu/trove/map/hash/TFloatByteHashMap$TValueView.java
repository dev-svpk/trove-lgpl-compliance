...
public class TFloatByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TFloatByteHashMap$TFloatByteValueHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TFloatByteHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatByteHashMap$TValueView$1(this, var1));
      var1.append("}");
