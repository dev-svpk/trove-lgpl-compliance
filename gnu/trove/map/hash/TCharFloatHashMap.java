...
public class TCharFloatHashMap extends TCharFloatHash implements gnu.trove.map.TCharFloatMap, Externalizable {
   ...
   public TCharFloatHashMap(gnu.trove.map.TCharFloatMap var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.TCharFloatMap var1) {
      this.ensureCapacity(var1.size());
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.TCharFloatMap)) {
         return false;
      } else {
         gnu.trove.map.TCharFloatMap var9;
         if ((var9 = (gnu.trove.map.TCharFloatMap)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
