...
public class TFloatDoubleHashMap$TKeyView implements TFloatSet {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TFloatDoubleHashMap$TFloatDoubleKeyHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TFloatDoubleHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(float var1) {
      return TFloatDoubleHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TFloatDoubleHashMap$TKeyView$1(this, var1));
      var1.append("}");
