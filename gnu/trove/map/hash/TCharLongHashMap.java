...
public class TCharLongHashMap extends TCharLongHash implements TCharLongMap, Externalizable {
   ...
   public boolean forEachKey(gnu.trove.procedure.TCharProcedure var1) {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TCharLongProcedure var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TCharLongProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharLongMap)) {
         ...
         TCharLongMap var15;
         if ((var15 = (TCharLongMap)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
