...
public class TIntShortHashMap$TKeyView implements TIntSet {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntShortHashMap$TIntShortKeyHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TIntShortHashMap.access$0(this.this$0);
   }

   public int size() {
      return TIntShortHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TIntShortHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(int var1) {
      return TIntShortHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TIntShortHashMap$TKeyView$1(this, var1));
      var1.append("}");
