...
public class TFloatShortHashMap$TKeyView implements TFloatSet {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TFloatShortHashMap$TFloatShortKeyHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TFloatShortHashMap.access$0(this.this$0);
   }

   public int size() {
      return TFloatShortHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TFloatShortHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(float var1) {
      return TFloatShortHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TFloatShortHashMap$TKeyView$1(this, var1));
      var1.append("}");
