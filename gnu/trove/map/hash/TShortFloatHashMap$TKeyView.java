...
public class TShortFloatHashMap$TKeyView implements TShortSet {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortFloatHashMap$TShortFloatKeyHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortFloatHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(short var1) {
      return TShortFloatHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TShortFloatHashMap$TKeyView$1(this, var1));
      var1.append("}");
