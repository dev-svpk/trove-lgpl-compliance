...
public class TByteFloatHashMap extends TByteFloatHash implements gnu.trove.map.TByteFloatMap, Externalizable {
   ...
   public TByteFloatHashMap(gnu.trove.map.TByteFloatMap var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.TByteFloatMap var1) {
      this.ensureCapacity(var1.size());
   ...
   public boolean forEachEntry(gnu.trove.procedure.TByteFloatProcedure var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TByteFloatProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.TByteFloatMap)) {
         return false;
      } else {
         gnu.trove.map.TByteFloatMap var9;
         if ((var9 = (gnu.trove.map.TByteFloatMap)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
