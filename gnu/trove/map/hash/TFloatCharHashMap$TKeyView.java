...
public class TFloatCharHashMap$TKeyView implements TFloatSet {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TFloatCharHashMap$TFloatCharKeyHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TFloatCharHashMap.access$0(this.this$0);
   }

   public int size() {
      return TFloatCharHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TFloatCharHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(float var1) {
      return TFloatCharHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TFloatCharHashMap$TKeyView$1(this, var1));
      var1.append("}");
