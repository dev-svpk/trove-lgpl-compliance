...
public class TDoubleLongHashMap$TKeyView implements TDoubleSet {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleLongHashMap$TDoubleLongKeyHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleLongHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(double var1) {
      return TDoubleLongHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TDoubleLongHashMap$TKeyView$1(this, var1));
      var1.append("}");
