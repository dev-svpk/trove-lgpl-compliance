...
public class TShortIntHashMap$TKeyView implements TShortSet {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortIntHashMap$TShortIntKeyHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortIntHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(short var1) {
      return TShortIntHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TShortIntHashMap$TKeyView$1(this, var1));
      var1.append("}");
