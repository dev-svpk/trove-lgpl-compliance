...
class TCharDoubleHashMap$TCharDoubleHashIterator extends THashPrimitiveIterator implements TCharDoubleIterator {
   // $FF: synthetic field
   final TCharDoubleHashMap this$0;

   TCharDoubleHashMap$TCharDoubleHashIterator(TCharDoubleHashMap var1, TCharDoubleHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
