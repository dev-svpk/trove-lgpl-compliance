...
class TObjectShortHashMap$TShortValueCollection implements TShortCollection {
   // $FF: synthetic field
   ...
   public int size() {
      return TObjectShortHashMap.access$0(this.this$0);
   }

   public boolean isEmpty() {
      return TObjectShortHashMap.access$0(this.this$0) == 0;
   }
   ...
   public boolean remove(short var1) {
      ...
      } while(var3[var4] == TObjectShortHashMap.FREE || var3[var4] == TObjectShortHashMap.REMOVED || var1 != var2[var4]);
   ...
   public boolean retainAll(short[] var1) {
      ...
      while(var5-- > 0) {
         if (var4[var5] != TObjectShortHashMap.FREE && var4[var5] != TObjectShortHashMap.REMOVED && Arrays.binarySearch(var1, var3[var5]) < 0) {
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TObjectShortHashMap$TShortValueCollection$1(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static TObjectShortHashMap access$0(TObjectShortHashMap$TShortValueCollection var0) {
      return var0.this$0;
   }
}
