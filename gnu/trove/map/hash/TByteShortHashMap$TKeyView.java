...
public class TByteShortHashMap$TKeyView implements TByteSet {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteShortHashMap$TByteShortKeyHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteShortHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(byte var1) {
      return TByteShortHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TByteShortHashMap$TKeyView$1(this, var1));
      var1.append("}");
