...
public class TDoubleShortHashMap$TKeyView implements TDoubleSet {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleShortHashMap$TDoubleShortKeyHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleShortHashMap.access$0(this.this$0);
   }

   public int size() {
      return TDoubleShortHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TDoubleShortHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(double var1) {
      return TDoubleShortHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TDoubleShortHashMap$TKeyView$1(this, var1));
      var1.append("}");
