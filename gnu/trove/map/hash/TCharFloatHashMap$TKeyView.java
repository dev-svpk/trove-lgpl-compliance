...
public class TCharFloatHashMap$TKeyView implements TCharSet {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TCharFloatHashMap$TCharFloatKeyHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TCharFloatHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(char var1) {
      return TCharFloatHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TCharFloatHashMap$TKeyView$1(this, var1));
      var1.append("}");
