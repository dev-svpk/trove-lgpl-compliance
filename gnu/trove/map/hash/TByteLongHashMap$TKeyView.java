...
public class TByteLongHashMap$TKeyView implements TByteSet {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteLongHashMap$TByteLongKeyHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteLongHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(byte var1) {
      return TByteLongHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TByteLongHashMap$TKeyView$1(this, var1));
      var1.append("}");
