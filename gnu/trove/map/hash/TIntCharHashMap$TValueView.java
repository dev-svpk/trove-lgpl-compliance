...
public class TIntCharHashMap$TValueView implements TCharCollection {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TIntCharHashMap$TIntCharValueHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TIntCharHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntCharHashMap$TValueView$1(this, var1));
      var1.append("}");
