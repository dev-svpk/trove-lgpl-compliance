...
public final class c extends O_ref implements gnu.trove.f_ref.e, Externalizable {
   ...
   public final boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.f_ref.e)) {
         return false;
      } else {
         gnu.trove.f_ref.e var3;
         if ((var3 = (gnu.trove.f_ref.e)var1).size() != this.size()) {
            return false;
         } else {
