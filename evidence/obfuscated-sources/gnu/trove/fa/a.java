...
public final class a extends m implements gnu.trove.f_ref.b, Externalizable {
   ...
   public final boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.f_ref.b)) {
         return false;
      } else {
         gnu.trove.f_ref.b var3;
         if ((var3 = (gnu.trove.f_ref.b)var1).size() != this.size()) {
            return false;
         } else {
