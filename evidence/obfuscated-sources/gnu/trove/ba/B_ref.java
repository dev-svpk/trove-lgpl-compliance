...
public abstract class B_ref extends ab {
   ...
   public B_ref(int var1) {
      super(var1);
      this.no_entry_key = 0.0F;
      this.no_entry_value = 0.0D;
   }

   public B_ref(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0.0F;
      this.no_entry_value = 0.0D;
   }

   public B_ref(int var1, float var2, float var3, double var4) {
      super(var1, var2);
   ...
   public boolean forEach(gnu.trove.e_ref.I_ref var1) {
   ...
   protected int XinsertKey(float var1) {
      ...
      int var2;
      int var3 = (var2 = gnu.trove.b_ref.b.a(var1) & Integer.MAX_VALUE) % var4;
      byte var7 = var5[var3];
      this.consumeFreeSlot = false;
      if (var7 == 0) {
         this.consumeFreeSlot = true;
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(B_ref.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
