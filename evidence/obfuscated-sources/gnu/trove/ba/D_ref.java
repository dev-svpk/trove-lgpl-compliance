...
public abstract class D_ref extends ab {
   ...
   public D_ref() {
      this.no_entry_value = gnu.trove.b_ref.a.f;
   ...
   public D_ref(int var1, float var2) {
      super(var1, var2);
      this.no_entry_value = gnu.trove.b_ref.a.f;
      if (this.no_entry_value != 0.0F) {
         Arrays.fill(this._set, this.no_entry_value);
   ...
   public D_ref(int var1, float var2, float var3) {
      super(var1, var2);
