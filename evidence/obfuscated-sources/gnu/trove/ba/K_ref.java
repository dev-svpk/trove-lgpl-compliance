...
public abstract class K_ref extends ab {
   ...
   public K_ref(int var1) {
      super(var1);
      this.no_entry_key = 0;
      this.no_entry_value = 0;
   }

   public K_ref(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0;
      this.no_entry_value = 0;
   }

   public K_ref(int var1, float var2, int var3, byte var4) {
      super(var1, var2);
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(K_ref.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
