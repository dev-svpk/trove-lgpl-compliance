...
public abstract class T_ref extends ab {
   ...
   public T_ref(int var1) {
      super(var1);
      this.no_entry_key = 0L;
      this.no_entry_value = 0;
   }

   public T_ref(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0L;
      this.no_entry_value = 0;
   }

   public T_ref(int var1, float var2, long var3, char var5) {
      super(var1, var2);
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(T_ref.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
