...
public abstract class H_ref implements Externalizable {
   ...
   public H_ref(int var1) {
      this(var1, 0.5F);
   }

   public H_ref(int var1, float var2) {
      this._autoCompactTemporaryDisable = false;
      this._loadFactor = var2;
      this._autoCompactionFactor = var2;
      this.setUp(gnu.trove.b_ref.b.b((float)var1 / var2));
   }
   ...
   public void ensureCapacity(int var1) {
      if (var1 > this._maxSize - this.size()) {
         this.rehash(gnu.trove.b_ref.c.a(Math.max(this.size() + 1, gnu.trove.b_ref.b.b((float)(var1 + this.size()) / this._loadFactor) + 1)));
   ...
   public void compact() {
      this.rehash(gnu.trove.b_ref.c.a(Math.max(this._size + 1, gnu.trove.b_ref.b.b((float)this.size() / this._loadFactor) + 1)));
      this.computeMaxSize(this.capacity());
   ...
   public void setAutoCompactionFactor(float var1) {
      if (var1 < 0.0F) {
         throw new IllegalArgumentException("Factor must be >= 0: ".concat(String.valueOf(var1)));
      } else {
   ...
   protected int setUp(int var1) {
      int var2 = gnu.trove.b_ref.c.a(var1);
   ...
   protected final void postInsertHook(boolean var1) {
      ...
      if (++this._size > this._maxSize || this._free == 0) {
         int var2 = this._size > this._maxSize ? gnu.trove.b_ref.c.a(this.capacity() << 1) : this.capacity();
         this.rehash(var2);
         this.computeMaxSize(this.capacity());
      }
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(H_ref.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
