...
public abstract class F_ref extends ab {
   ...
   public F_ref(int var1) {
      super(var1);
      this.no_entry_key = 0.0F;
      this.no_entry_value = 0L;
   }

   public F_ref(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0.0F;
      this.no_entry_value = 0L;
   }

   public F_ref(int var1, float var2, float var3, long var4) {
      super(var1, var2);
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(F_ref.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
