...
public abstract class P_ref extends ab {
   ...
   public P_ref(int var1) {
      super(var1);
      this.no_entry_key = 0;
      this.no_entry_value = 0;
   }

   public P_ref(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0;
      this.no_entry_value = 0;
   }

   public P_ref(int var1, float var2, int var3, int var4) {
      super(var1, var2);
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(P_ref.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
