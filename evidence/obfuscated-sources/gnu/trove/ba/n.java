...
public abstract class n extends ab {
   ...
   public n(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0;
      this.no_entry_value = 0;
   }

   public n(int var1, float var2, char var3, int var4) {
      super(var1, var2);
   ...
   public boolean forEach(gnu.trove.e_ref.q var1) {
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(n.class.getName()).log(Level.SEVERE, null, ex);
       }
   }
