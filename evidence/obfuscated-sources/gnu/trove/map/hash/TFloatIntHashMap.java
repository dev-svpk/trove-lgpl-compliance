...
public class TFloatIntHashMap extends E_ref implements C_ref, Externalizable {
   ...
   public TFloatIntHashMap(C_ref var1) {
      super(var1.size());
   ...
   public void putAll(C_ref var1) {
      this.ensureCapacity(var1.size());
      G_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(F_ref var1) {
      byte[] var2 = this._states;
      float[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(F_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof C_ref)) {
         return false;
      } else {
         C_ref var9;
         if ((var9 = (C_ref)var1).size() != this.size()) {
            return false;
         } else {
            int[] var2 = this._values;
            byte[] var3 = this._states;
