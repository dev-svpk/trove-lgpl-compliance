...
import gnu.trove.ba.k;
import gnu.trove.c_ref.m;
...
public class TCharDoubleHashMap extends k implements gnu.trove.map.k, Externalizable {
   ...
   public TCharDoubleHashMap(gnu.trove.map.k var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.k var1) {
      this.ensureCapacity(var1.size());
      m var2 = var1.iterator();
   ...
   public boolean forEachEntry(l var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      double[] var4 = this._values;
   ...
   public boolean retainEntries(l var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.k)) {
         return false;
      } else {
         gnu.trove.map.k var15;
         if ((var15 = (gnu.trove.map.k)var1).size() != this.size()) {
            return false;
         } else {
            double[] var2 = this._values;
            byte[] var3 = this._states;
