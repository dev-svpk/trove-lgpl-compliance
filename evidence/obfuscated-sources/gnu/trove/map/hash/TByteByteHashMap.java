...
import gnu.trove.ba.a;
import gnu.trove.c_ref.b;
...
public class TByteByteHashMap extends a implements gnu.trove.map.a, Externalizable {
   ...
   public TByteByteHashMap(gnu.trove.map.a var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.a var1) {
      this.ensureCapacity(var1.size());
      b var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.a var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.a var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.a)) {
         return false;
      } else {
         gnu.trove.map.a var9;
         if ((var9 = (gnu.trove.map.a)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
