...
class TCharDoubleHashMap$TCharDoubleKeyHashIterator extends J_ref implements p {
   // $FF: synthetic field
   final TCharDoubleHashMap this$0;

   TCharDoubleHashMap$TCharDoubleKeyHashIterator(TCharDoubleHashMap var1, ab var2) {
      super(var2);
      this.this$0 = var1;
   }
