...
public class TFloatObjectHashMap extends D_ref implements E_ref, Externalizable {
   static final long serialVersionUID = 1L;
   private final H_ref PUT_ALL_PROC;
   ...
   public TFloatObjectHashMap(E_ref var1) {
   ...
   public boolean forEachEntry(H_ref var1) {
      byte[] var2 = this._states;
      float[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(H_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof E_ref)) {
         return false;
      } else {
         E_ref var6;
         if ((var6 = (E_ref)var1).size() != this.size()) {
            return false;
         } else {
            try {
               J_ref var2 = this.iterator();
