...
public class TFloatDoubleHashMap extends B_ref implements A_ref, Externalizable {
   ...
   public TFloatDoubleHashMap(A_ref var1) {
      super(var1.size());
   ...
   public void putAll(A_ref var1) {
      this.ensureCapacity(var1.size());
      E_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(D_ref var1) {
      byte[] var2 = this._states;
      float[] var3 = this._set;
      double[] var4 = this._values;
   ...
   public boolean retainEntries(D_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof A_ref)) {
         return false;
      } else {
         A_ref var15;
         if ((var15 = (A_ref)var1).size() != this.size()) {
            return false;
         } else {
            double[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TFloatDoubleHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static float access$0(TFloatDoubleHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TFloatDoubleHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static double access$2(TFloatDoubleHashMap var0) {
