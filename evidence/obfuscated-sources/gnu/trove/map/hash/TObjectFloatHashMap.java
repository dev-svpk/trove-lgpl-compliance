...
public class TObjectFloatHashMap extends aa implements gnu.trove.map.aa, Externalizable {
   static final long serialVersionUID = 1L;
   private final af PUT_ALL_PROC;
   protected transient float[] _values;
   protected float no_entry_value;

   public TObjectFloatHashMap() {
      this.PUT_ALL_PROC = new TObjectFloatHashMap$1(this);
      this.no_entry_value = a.f;
   }
   ...
   public TObjectFloatHashMap(gnu.trove.map.aa var1) {
   ...
   public void putAll(gnu.trove.map.aa var1) {
   ...
   public boolean forEachEntry(af var1) {
      Object[] var2 = this._set;
      float[] var3 = this._values;
      int var4 = var2.length;
   ...
   public boolean retainEntries(af var1) {
      boolean var2 = false;
      Object[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.aa)) {
         return false;
      } else {
         gnu.trove.map.aa var6;
         if ((var6 = (gnu.trove.map.aa)var1).size() != this.size()) {
            return false;
         } else {
            try {
               ah var2 = this.iterator();
