...
import gnu.trove.ba.ac;
import gnu.trove.c_ref.am;
...
public class TShortByteHashMap extends ac implements ae, Externalizable {
   ...
   public TShortByteHashMap(ae var1) {
      super(var1.size());
   ...
   public void putAll(ae var1) {
      this.ensureCapacity(var1.size());
      am var2 = var1.iterator();
   ...
   public boolean forEachEntry(ak var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(ak var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ae)) {
         ...
         ae var9;
         if ((var9 = (ae)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortByteHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static short access$0(TShortByteHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TShortByteHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static byte access$2(TShortByteHashMap var0) {
