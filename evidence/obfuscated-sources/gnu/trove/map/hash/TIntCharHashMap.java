...
import gnu.trove.ba.L_ref;
import gnu.trove.c_ref.M_ref;
import gnu.trove.e_ref.R_ref;
import gnu.trove.e_ref.q;
import gnu.trove.f_ref.e;
import gnu.trove.map.H_ref;
...
public class TIntCharHashMap extends L_ref implements H_ref, Externalizable {
   ...
   public TIntCharHashMap(H_ref var1) {
      super(var1.size());
   ...
   public void putAll(H_ref var1) {
      this.ensureCapacity(var1.size());
      M_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.L_ref var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      char[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.L_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof H_ref)) {
         return false;
      } else {
         H_ref var9;
         if ((var9 = (H_ref)var1).size() != this.size()) {
            return false;
         } else {
            char[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntCharHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static int access$0(TIntCharHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TIntCharHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static char access$2(TIntCharHashMap var0) {
