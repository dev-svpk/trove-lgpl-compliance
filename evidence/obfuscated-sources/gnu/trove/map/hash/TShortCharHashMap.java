...
import gnu.trove.ba.ad;
import gnu.trove.c_ref.an;
import gnu.trove.e_ref.al;
...
public class TShortCharHashMap extends ad implements af, Externalizable {
   ...
   public TShortCharHashMap(af var1) {
      super(var1.size());
   ...
   public void putAll(af var1) {
      this.ensureCapacity(var1.size());
      an var2 = var1.iterator();
   ...
   public boolean forEachEntry(al var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      char[] var4 = this._values;
   ...
   public boolean retainEntries(al var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof af)) {
         ...
         af var9;
         if ((var9 = (af)var1).size() != this.size()) {
            return false;
         } else {
            char[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortCharHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static short access$0(TShortCharHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TShortCharHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static char access$2(TShortCharHashMap var0) {
