...
import gnu.trove.ba.af;
import gnu.trove.c_ref.ap;
import gnu.trove.e_ref.I_ref;
import gnu.trove.e_ref.an;
...
public class TShortFloatHashMap extends af implements ah, Externalizable {
   ...
   public TShortFloatHashMap(ah var1) {
      super(var1.size());
   ...
   public void putAll(ah var1) {
      this.ensureCapacity(var1.size());
      ap var2 = var1.iterator();
   ...
   public boolean forEachEntry(an var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(an var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ah)) {
         ...
         ah var9;
         if ((var9 = (ah)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortFloatHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static short access$0(TShortFloatHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TShortFloatHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static float access$2(TShortFloatHashMap var0) {
