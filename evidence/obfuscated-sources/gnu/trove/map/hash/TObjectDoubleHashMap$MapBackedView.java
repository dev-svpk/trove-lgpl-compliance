...
abstract class TObjectDoubleHashMap$MapBackedView extends AbstractSet implements Iterable, Set {
   // $FF: synthetic field
   ...
   // $FF: synthetic method
   TObjectDoubleHashMap$MapBackedView(TObjectDoubleHashMap var1, TObjectDoubleHashMap$MapBackedView var2) {
      this(var1);
   }
}
