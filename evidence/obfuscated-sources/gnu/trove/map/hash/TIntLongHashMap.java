...
import gnu.trove.ba.Q_ref;
import gnu.trove.c_ref.R_ref;
import gnu.trove.e_ref.P_ref;
import gnu.trove.e_ref.aa;
import gnu.trove.f_ref.e;
import gnu.trove.map.L_ref;
...
public class TIntLongHashMap extends Q_ref implements L_ref, Externalizable {
   ...
   public TIntLongHashMap(L_ref var1) {
      super(var1.size());
   ...
   public void putAll(L_ref var1) {
      this.ensureCapacity(var1.size());
      R_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(P_ref var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean retainEntries(P_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof L_ref)) {
         return false;
      } else {
         L_ref var15;
         if ((var15 = (L_ref)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntLongHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static int access$0(TIntLongHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TIntLongHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static long access$2(TIntLongHashMap var0) {
