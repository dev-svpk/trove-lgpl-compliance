...
import gnu.trove.ba.aj;
import gnu.trove.c_ref.au;
import gnu.trove.e_ref.ar;
import gnu.trove.e_ref.as;
...
public class TShortShortHashMap extends aj implements al, Externalizable {
   ...
   public TShortShortHashMap(al var1) {
      super(var1.size());
   ...
   public void putAll(al var1) {
      this.ensureCapacity(var1.size());
      au var2 = var1.iterator();
   ...
   public boolean forEachEntry(as var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public boolean retainEntries(as var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof al)) {
         ...
         al var9;
         if ((var9 = (al)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortShortHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static short access$0(TShortShortHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TShortShortHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static short access$2(TShortShortHashMap var0) {
