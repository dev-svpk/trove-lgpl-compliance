...
public class TIntFloatHashMap extends N_ref implements J_ref, Externalizable {
   ...
   public TIntFloatHashMap(J_ref var1) {
      super(var1.size());
   ...
   public void putAll(J_ref var1) {
      this.ensureCapacity(var1.size());
      O_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.N_ref var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.N_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof J_ref)) {
         return false;
      } else {
         J_ref var9;
         if ((var9 = (J_ref)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntFloatHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static int access$0(TIntFloatHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TIntFloatHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static float access$2(TIntFloatHashMap var0) {
