...
import gnu.trove.ba.Y_ref;
import gnu.trove.c_ref.ab;
import gnu.trove.e_ref.aa;
import gnu.trove.f_ref.f;
import gnu.trove.map.T_ref;
...
public class TLongLongHashMap extends Y_ref implements T_ref, Externalizable {
   ...
   public TLongLongHashMap(T_ref var1) {
      super(var1.size());
   ...
   public void putAll(T_ref var1) {
      this.ensureCapacity(var1.size());
      ab var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.Y_ref var1) {
      byte[] var2 = this._states;
      long[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.Y_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      long[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof T_ref)) {
         return false;
      } else {
         T_ref var16;
         if ((var16 = (T_ref)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
