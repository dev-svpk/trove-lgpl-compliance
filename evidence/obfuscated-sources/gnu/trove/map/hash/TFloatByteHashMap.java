...
import gnu.trove.ba.z;
import gnu.trove.c_ref.C_ref;
...
public class TFloatByteHashMap extends z implements y, Externalizable {
   ...
   public TFloatByteHashMap(y var1) {
      super(var1.size());
   ...
   public void putAll(y var1) {
      this.ensureCapacity(var1.size());
      C_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(B_ref var1) {
      byte[] var2 = this._states;
      float[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(B_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TFloatByteHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static float access$0(TFloatByteHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TFloatByteHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static byte access$2(TFloatByteHashMap var0) {
