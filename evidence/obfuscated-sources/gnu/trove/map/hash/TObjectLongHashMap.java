...
public class TObjectLongHashMap extends aa implements ac, Externalizable {
   static final long serialVersionUID = 1L;
   private final ah PUT_ALL_PROC;
   protected transient long[] _values;
   protected long no_entry_value;

   public TObjectLongHashMap() {
      this.PUT_ALL_PROC = new TObjectLongHashMap$1(this);
      this.no_entry_value = a.e;
   }
   ...
   public TObjectLongHashMap(ac var1) {
   ...
   public boolean forEachValue(gnu.trove.e_ref.aa var1) {
   ...
   public boolean forEachEntry(ah var1) {
      Object[] var2 = this._set;
      long[] var3 = this._values;
      int var4 = var2.length;
   ...
   public boolean retainEntries(ah var1) {
      boolean var2 = false;
      Object[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ac)) {
         ...
         ac var8;
         if ((var8 = (ac)var1).size() != this.size()) {
            return false;
         } else {
            try {
               aj var2 = this.iterator();
