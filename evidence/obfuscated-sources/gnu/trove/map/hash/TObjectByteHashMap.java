...
public class TObjectByteHashMap extends aa implements X_ref, Externalizable {
   static final long serialVersionUID = 1L;
   private final ac PUT_ALL_PROC;
   protected transient byte[] _values;
   protected byte no_entry_value;

   public TObjectByteHashMap() {
      this.PUT_ALL_PROC = new TObjectByteHashMap$1(this);
      this.no_entry_value = a.a;
   }
   ...
   public TObjectByteHashMap(X_ref var1) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put(var3.getKey(), (Byte)var3.getValue());
      }

   }

   public void putAll(X_ref var1) {
   ...
   public boolean forEachEntry(ac var1) {
      Object[] var2 = this._set;
      byte[] var3 = this._values;
      int var4 = var2.length;
   ...
   public boolean retainEntries(ac var1) {
      boolean var2 = false;
      Object[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof X_ref)) {
         return false;
      } else {
         X_ref var6;
         if ((var6 = (X_ref)var1).size() != this.size()) {
            return false;
         } else {
            try {
               ae var2 = this.iterator();
   ...
   public String toString() {
      ...
      this.forEachEntry(new TObjectByteHashMap$2(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static int access$0(TObjectByteHashMap var0) {
      return var0._size;
   }
}
