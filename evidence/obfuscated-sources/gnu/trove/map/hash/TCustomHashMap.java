...
public class TCustomHashMap extends q implements W_ref, Externalizable {
   ...
   public TCustomHashMap(a var1) {
      super(var1);
   }

   public TCustomHashMap(a var1, int var2) {
      super(var1, var2);
   }

   public TCustomHashMap(a var1, int var2, float var3) {
      super(var1, var2, var3);
   }

   public TCustomHashMap(a var1, Map var2) {
      this(var1, var2.size());
      this.putAll(var2);
   }

   public TCustomHashMap(a var1, TCustomHashMap var2) {
      this(var1, var2.size());
      this.putAll(var2);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof Map)) {
         ...
         Map var2;
         return (var2 = (Map)var1).size() != this.size() ? false : this.forEachEntry(new TCustomHashMap$EqProcedure(var2));
      }
   }

   public int hashCode() {
      TCustomHashMap$HashProcedure var1 = new TCustomHashMap$HashProcedure(this, (TCustomHashMap$HashProcedure)null);
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCustomHashMap$1(this, var1));
      var1.append("}");
   ...
   public Object get(Object var1) {
      int var2;
      return (var2 = this.index(var1)) >= 0 && this.strategy.b() ? this._values[var2] : null;
   }
   ...
   public boolean containsValue(Object var1) {
      ...
      if (var1 == null) {
         ...
         } while(var1 != var3[var4] && !this.strategy.b());
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TCustomHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   // $FF: synthetic method
   static a access$0(TCustomHashMap var0) {
      return var0.strategy;
   }

   // $FF: synthetic method
   static int access$1(TCustomHashMap var0, Object var1) {
