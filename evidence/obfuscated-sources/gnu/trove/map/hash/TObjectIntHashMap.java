...
public class TObjectIntHashMap extends aa implements ab, Externalizable {
   static final long serialVersionUID = 1L;
   private final ag PUT_ALL_PROC;
   protected transient int[] _values;
   protected int no_entry_value;

   public TObjectIntHashMap() {
      this.PUT_ALL_PROC = new TObjectIntHashMap$1(this);
      this.no_entry_value = a.d;
   }
   ...
   public TObjectIntHashMap(ab var1) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put(var3.getKey(), (Integer)var3.getValue());
      }

   }

   public void putAll(ab var1) {
   ...
   public boolean forEachEntry(ag var1) {
      Object[] var2 = this._set;
      int[] var3 = this._values;
      int var4 = var2.length;
   ...
   public boolean retainEntries(ag var1) {
      boolean var2 = false;
      Object[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public void transformValues$637dbeb2(gnu.trove.a_ref.a var1) {
      Object[] var2 = this._set;
      int[] var3;
      int var4 = (var3 = this._values).length;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ab)) {
         ...
         ab var6;
         if ((var6 = (ab)var1).size() != this.size()) {
            return false;
         } else {
            try {
               ai var2 = this.iterator();
   ...
   public String toString() {
      ...
      this.forEachEntry(new TObjectIntHashMap$2(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static int access$0(TObjectIntHashMap var0) {
      return var0._size;
   }
}
