...
import gnu.trove.ba.g;
import gnu.trove.c_ref.h;
...
public class TByteLongHashMap extends g implements f, Externalizable {
   ...
   public TByteLongHashMap(f var1) {
      super(var1.size());
   ...
   public void putAll(f var1) {
      this.ensureCapacity(var1.size());
      h var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.f var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public void transformValues$6f4d57c3(gnu.trove.a_ref.a var1) {
      byte[] var2 = this._states;
      long[] var3;
      int var4 = (var3 = this._values).length;
   ...
   public boolean retainEntries(gnu.trove.e_ref.f var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof f)) {
         ...
         f var15;
         if ((var15 = (f)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
