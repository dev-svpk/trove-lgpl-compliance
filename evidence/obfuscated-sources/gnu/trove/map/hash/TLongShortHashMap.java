...
public class TLongShortHashMap extends Z_ref implements V_ref, Externalizable {
   ...
   public TLongShortHashMap(V_ref var1) {
      super(var1.size());
   ...
   public void putAll(V_ref var1) {
      this.ensureCapacity(var1.size());
      ad var2 = var1.iterator();
   ...
   public boolean forEachEntry(ab var1) {
      byte[] var2 = this._states;
      long[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public boolean retainEntries(ab var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      long[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof V_ref)) {
         return false;
      } else {
         V_ref var10;
         if ((var10 = (V_ref)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TLongShortHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static long access$0(TLongShortHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TLongShortHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static short access$2(TLongShortHashMap var0) {
