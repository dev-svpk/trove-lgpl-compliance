...
import gnu.trove.ba.X_ref;
import gnu.trove.c_ref.Z_ref;
import gnu.trove.e_ref.R_ref;
import gnu.trove.e_ref.aa;
import gnu.trove.f_ref.f;
import gnu.trove.map.S_ref;
...
public class TLongIntHashMap extends X_ref implements S_ref, Externalizable {
   ...
   public TLongIntHashMap(S_ref var1) {
      super(var1.size());
   ...
   public void putAll(S_ref var1) {
      this.ensureCapacity(var1.size());
      Z_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.X_ref var1) {
      byte[] var2 = this._states;
      long[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.X_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      long[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof S_ref)) {
         return false;
      } else {
         S_ref var10;
         if ((var10 = (S_ref)var1).size() != this.size()) {
            return false;
         } else {
            int[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TLongIntHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static long access$0(TLongIntHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TLongIntHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static int access$2(TLongIntHashMap var0) {
