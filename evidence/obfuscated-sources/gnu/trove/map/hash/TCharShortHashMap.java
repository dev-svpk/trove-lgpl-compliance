...
import gnu.trove.ba.p;
import gnu.trove.c_ref.s;
...
public class TCharShortHashMap extends p implements gnu.trove.map.p, Externalizable {
   ...
   public TCharShortHashMap(gnu.trove.map.p var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.p var1) {
      this.ensureCapacity(var1.size());
      s var2 = var1.iterator();
   ...
   public boolean forEachEntry(r var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public boolean retainEntries(r var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.p)) {
         return false;
      } else {
         gnu.trove.map.p var9;
         if ((var9 = (gnu.trove.map.p)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharShortHashMap$1(this, var1));
      var1.append("}");
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TCharShortHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   // $FF: synthetic method
   static char access$0(TCharShortHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TCharShortHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static short access$2(TCharShortHashMap var0) {
