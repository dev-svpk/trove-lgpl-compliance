...
import gnu.trove.ba.u;
import gnu.trove.c_ref.w;
...
public class TDoubleFloatHashMap extends u implements t, Externalizable {
   ...
   public TDoubleFloatHashMap(t var1) {
      super(var1.size());
   ...
   public void putAll(t var1) {
      this.ensureCapacity(var1.size());
      w var2 = var1.iterator();
   ...
   public boolean forEachEntry(v var1) {
      byte[] var2 = this._states;
      double[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(v var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof t)) {
         ...
         t var10;
         if ((var10 = (t)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TDoubleFloatHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static double access$0(TDoubleFloatHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TDoubleFloatHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static float access$2(TDoubleFloatHashMap var0) {
