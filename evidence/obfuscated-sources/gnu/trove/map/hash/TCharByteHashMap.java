...
import gnu.trove.a;
import gnu.trove.ba.i;
import gnu.trove.c_ref.k;
...
public class TCharByteHashMap extends i implements gnu.trove.map.i, Externalizable {
   ...
   public TCharByteHashMap(gnu.trove.map.i var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.i var1) {
      this.ensureCapacity(var1.size());
      k var2 = var1.iterator();
   ...
   public boolean forEachValue(h var1) {
      byte[] var2 = this._states;
      byte[] var3;
      int var4 = (var3 = this._values).length;
   ...
   public boolean forEachEntry(j var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(j var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.i)) {
         return false;
      } else {
         gnu.trove.map.i var9;
         if ((var9 = (gnu.trove.map.i)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharByteHashMap$1(this, var1));
      var1.append("}");
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TCharByteHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   // $FF: synthetic method
   static char access$0(TCharByteHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TCharByteHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static byte access$2(TCharByteHashMap var0) {
