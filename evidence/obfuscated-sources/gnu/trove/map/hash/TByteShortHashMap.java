...
import gnu.trove.ba.h;
import gnu.trove.c_ref.j;
...
public class TByteShortHashMap extends h implements gnu.trove.map.h, Externalizable {
   ...
   public TByteShortHashMap(gnu.trove.map.h var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.h var1) {
      this.ensureCapacity(var1.size());
      j var2 = var1.iterator();
   ...
   public boolean forEachKey(gnu.trove.e_ref.h var1) {
   ...
   public boolean forEachEntry(i var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public void transformValues$3f6b603b(gnu.trove.a_ref.a var1) {
      byte[] var2 = this._states;
      short[] var3;
      int var4 = (var3 = this._values).length;
   ...
   public boolean retainEntries(i var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.h)) {
         return false;
      } else {
         gnu.trove.map.h var9;
         if ((var9 = (gnu.trove.map.h)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TByteShortHashMap$1(this, var1));
      var1.append("}");
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TByteShortHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   // $FF: synthetic method
   static byte access$0(TByteShortHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TByteShortHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static short access$2(TByteShortHashMap var0) {
