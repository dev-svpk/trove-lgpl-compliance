...
public class TCharObjectHashMap extends m implements o, Externalizable {
   static final long serialVersionUID = 1L;
   private final p PUT_ALL_PROC;
   protected transient Object[] _values;
   protected char no_entry_key;

   public TCharObjectHashMap() {
      this.PUT_ALL_PROC = new TCharObjectHashMap$1(this);
   }

   public TCharObjectHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TCharObjectHashMap$1(this);
      this.no_entry_key = a.c;
   }
   ...
   public TCharObjectHashMap(o var1) {
   ...
   public boolean forEachEntry(p var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(p var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof o)) {
         ...
         o var6;
         if ((var6 = (o)var1).size() != this.size()) {
            return false;
         } else {
            try {
               r var2 = this.iterator();
   ...
   public int hashCode() {
      ...
      while(var4-- > 0) {
         if (var3[var4] == 1) {
            var1 += gnu.trove.b_ref.b.a(this._set[var4]) ^ (var2[var4] == null ? 0 : var2[var4].hashCode());
         }
      }
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TCharObjectHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharObjectHashMap$2(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static int access$0(TCharObjectHashMap var0) {
      return var0._size;
   }
}
