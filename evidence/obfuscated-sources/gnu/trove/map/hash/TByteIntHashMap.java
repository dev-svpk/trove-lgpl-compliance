...
public class TByteIntHashMap extends f implements e, Externalizable {
   ...
   public void putAll(e var1) {
      this.ensureCapacity(var1.size());
      gnu.trove.c_ref.f var2 = var1.iterator();
   ...
   public gnu.trove.c_ref.f iterator() {
   ...
   public boolean forEachEntry(gnu.trove.e_ref.e var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.e var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
