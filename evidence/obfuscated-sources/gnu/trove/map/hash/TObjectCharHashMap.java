...
public class TObjectCharHashMap extends aa implements Y_ref, Externalizable {
   static final long serialVersionUID = 1L;
   private final ad PUT_ALL_PROC;
   protected transient char[] _values;
   protected char no_entry_value;

   public TObjectCharHashMap() {
      this.PUT_ALL_PROC = new TObjectCharHashMap$1(this);
      this.no_entry_value = a.c;
   }
   ...
   public TObjectCharHashMap(Y_ref var1) {
   ...
   public boolean forEachEntry(ad var1) {
      Object[] var2 = this._set;
      char[] var3 = this._values;
      int var4 = var2.length;
   ...
   public boolean retainEntries(ad var1) {
      boolean var2 = false;
      Object[] var3 = this._set;
      char[] var4 = this._values;
   ...
   public void transformValues$5180dea9(gnu.trove.a_ref.a var1) {
      Object[] var2 = this._set;
      char[] var3;
      int var4 = (var3 = this._values).length;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof Y_ref)) {
         return false;
      } else {
         Y_ref var6;
         if ((var6 = (Y_ref)var1).size() != this.size()) {
            return false;
         } else {
            try {
               af var2 = this.iterator();
   ...
   public int hashCode() {
      ...
      while(var4-- > 0) {
         if (var2[var4] != FREE && var2[var4] != REMOVED) {
            var1 += gnu.trove.b_ref.b.a(var3[var4]) ^ (var2[var4] == null ? 0 : var2[var4].hashCode());
         }
      }
