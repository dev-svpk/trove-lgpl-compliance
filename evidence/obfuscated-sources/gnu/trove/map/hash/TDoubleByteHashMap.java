...
public class TDoubleByteHashMap extends r implements q, Externalizable {
   ...
   public TDoubleByteHashMap(q var1) {
      super(var1.size());
   ...
   public void putAll(q var1) {
      this.ensureCapacity(var1.size());
      t var2 = var1.iterator();
   ...
   public boolean forEachEntry(s var1) {
      byte[] var2 = this._states;
      double[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(s var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof q)) {
         ...
         q var10;
         if ((var10 = (q)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
