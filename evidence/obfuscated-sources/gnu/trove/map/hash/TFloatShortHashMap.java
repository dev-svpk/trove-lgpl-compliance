...
public class TFloatShortHashMap extends G_ref implements F_ref, Externalizable {
   ...
   public TFloatShortHashMap(F_ref var1) {
      super(var1.size());
   ...
   public void putAll(F_ref var1) {
      this.ensureCapacity(var1.size());
      K_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(J_ref var1) {
      byte[] var2 = this._states;
      float[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public boolean retainEntries(J_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof F_ref)) {
         return false;
      } else {
         F_ref var9;
         if ((var9 = (F_ref)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TFloatShortHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static float access$0(TFloatShortHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TFloatShortHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static short access$2(TFloatShortHashMap var0) {
