...
import gnu.trove.ba.y;
import gnu.trove.c_ref.B_ref;
...
public class TDoubleShortHashMap extends y implements x, Externalizable {
   ...
   public TDoubleShortHashMap(x var1) {
      super(var1.size());
   ...
   public void putAll(x var1) {
      this.ensureCapacity(var1.size());
      B_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(A_ref var1) {
      byte[] var2 = this._states;
      double[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public boolean retainEntries(A_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof x)) {
         ...
         x var10;
         if ((var10 = (x)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
