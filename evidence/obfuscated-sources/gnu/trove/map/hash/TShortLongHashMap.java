...
import gnu.trove.ba.ai;
import gnu.trove.c_ref.as;
...
public class TShortLongHashMap extends ai implements aj, Externalizable {
   ...
   public TShortLongHashMap(aj var1) {
      super(var1.size());
   ...
   public void putAll(aj var1) {
      this.ensureCapacity(var1.size());
      as var2 = var1.iterator();
   ...
   public boolean forEachEntry(ap var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean retainEntries(ap var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof aj)) {
         ...
         aj var15;
         if ((var15 = (aj)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortLongHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static short access$0(TShortLongHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TShortLongHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static long access$2(TShortLongHashMap var0) {
