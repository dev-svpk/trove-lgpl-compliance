...
import gnu.trove.ba.ag;
import gnu.trove.c_ref.at;
...
public class TShortObjectHashMap extends ag implements ak, Externalizable {
   static final long serialVersionUID = 1L;
   private final aq PUT_ALL_PROC;
   protected transient Object[] _values;
   protected short no_entry_key;

   public TShortObjectHashMap() {
      this.PUT_ALL_PROC = new TShortObjectHashMap$1(this);
   }

   public TShortObjectHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TShortObjectHashMap$1(this);
      this.no_entry_key = a.b;
   }
   ...
   public TShortObjectHashMap(ak var1) {
   ...
   public boolean forEachEntry(aq var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(aq var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ak)) {
         ...
         ak var6;
         if ((var6 = (ak)var1).size() != this.size()) {
            return false;
         } else {
            try {
               at var2 = this.iterator();
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortObjectHashMap$2(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static int access$0(TShortObjectHashMap var0) {
      return var0._size;
   }
}
