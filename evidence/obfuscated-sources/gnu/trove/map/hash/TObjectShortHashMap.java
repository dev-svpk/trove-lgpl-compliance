...
public class TObjectShortHashMap extends aa implements ad, Externalizable {
   static final long serialVersionUID = 1L;
   private final aj PUT_ALL_PROC;
   protected transient short[] _values;
   protected short no_entry_value;

   public TObjectShortHashMap() {
      this.PUT_ALL_PROC = new TObjectShortHashMap$1(this);
      this.no_entry_value = a.b;
   }
   ...
   public TObjectShortHashMap(ad var1) {
   ...
   public boolean forEachEntry(aj var1) {
      Object[] var2 = this._set;
      short[] var3 = this._values;
      int var4 = var2.length;
   ...
   public boolean retainEntries(aj var1) {
      boolean var2 = false;
      Object[] var3 = this._set;
      short[] var4 = this._values;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ad)) {
         return false;
      } else {
         ad var6;
         if ((var6 = (ad)var1).size() != this.size()) {
            return false;
         } else {
            try {
               ak var2 = this.iterator();
