...
import gnu.trove.ba.K_ref;
import gnu.trove.c_ref.L_ref;
import gnu.trove.e_ref.R_ref;
import gnu.trove.e_ref.h;
import gnu.trove.f_ref.e;
import gnu.trove.map.G_ref;
...
public class TIntByteHashMap extends K_ref implements G_ref, Externalizable {
   ...
   public TIntByteHashMap(G_ref var1) {
      super(var1.size());
   ...
   public void putAll(G_ref var1) {
      this.ensureCapacity(var1.size());
      L_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.K_ref var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.K_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof G_ref)) {
         return false;
      } else {
         G_ref var9;
         if ((var9 = (G_ref)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntByteHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static int access$0(TIntByteHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TIntByteHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static byte access$2(TIntByteHashMap var0) {
