...
public class TIntObjectHashMap extends O_ref implements M_ref, Externalizable {
   static final long serialVersionUID = 1L;
   private final Q_ref PUT_ALL_PROC;
   protected transient Object[] _values;
   protected int no_entry_key;

   public TIntObjectHashMap() {
      this.PUT_ALL_PROC = new TIntObjectHashMap$1(this);
   }

   public TIntObjectHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TIntObjectHashMap$1(this);
      this.no_entry_key = a.d;
   }
   ...
   public TIntObjectHashMap(M_ref var1) {
   ...
   public Object get(int var1) {
      return (var1 = this.index(var1)) < 0 ? null : this._values[var1];
   }

   public Object put(int var1, Object var2) {
      var1 = this.insertKey(var1);
      return this.doPut(var2, var1);
   }

   public Object putIfAbsent(int var1, Object var2) {
      return (var1 = this.insertKey(var1)) < 0 ? this._values[-var1 - 1] : this.doPut(var2, var1);
   }
   ...
   public boolean forEachValue$1d6e2644(gnu.trove.a_ref.a var1) {
      byte[] var2 = this._states;
   ...
   public boolean forEachEntry(Q_ref var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(Q_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public void transformValues$2467b360(gnu.trove.a_ref.a var1) {
      byte[] var2 = this._states;
      Object[] var3;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof M_ref)) {
         return false;
      } else {
         M_ref var6;
         if ((var6 = (M_ref)var1).size() != this.size()) {
            return false;
         } else {
            try {
               S_ref var2 = this.iterator();
   ...
   public int hashCode() {
      ...
      while(var4-- > 0) {
         if (var3[var4] == 1) {
            var1 += b.a(this._set[var4]) ^ (var2[var4] == null ? 0 : var2[var4].hashCode());
         }
      }
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntObjectHashMap$2(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static int access$0(TIntObjectHashMap var0) {
      return var0._size;
   }
}
