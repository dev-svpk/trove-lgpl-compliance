...
import gnu.trove.ba.e;
import gnu.trove.c_ref.i;
...
public class TByteObjectHashMap extends e implements g, Externalizable {
   static final long serialVersionUID = 1L;
   private final gnu.trove.e_ref.g PUT_ALL_PROC;
   protected transient Object[] _values;
   protected byte no_entry_key;

   public TByteObjectHashMap() {
      this.PUT_ALL_PROC = new TByteObjectHashMap$1(this);
   }

   public TByteObjectHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TByteObjectHashMap$1(this);
      this.no_entry_key = a.a;
   }
   ...
   public TByteObjectHashMap(g var1) {
   ...
   public gnu.trove.f_ref.a keySet() {
   ...
   public boolean forEachEntry(gnu.trove.e_ref.g var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.g var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof g)) {
         ...
         g var6;
         if ((var6 = (g)var1).size() != this.size()) {
            return false;
         } else {
            try {
               i var2 = this.iterator();
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TByteObjectHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   public String toString() {
      ...
      this.forEachEntry(new TByteObjectHashMap$2(this, var1));
      var1.append("}");
      return var1.toString();
   }

   // $FF: synthetic method
   static int access$0(TByteObjectHashMap var0) {
      return var0._size;
   }
}
