...
public class TDoubleObjectHashMap extends v implements w, Externalizable {
   static final long serialVersionUID = 1L;
   private final y PUT_ALL_PROC;
   ...
   public TDoubleObjectHashMap(w var1) {
   ...
   public boolean forEachEntry(y var1) {
      byte[] var2 = this._states;
      double[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(y var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof w)) {
         ...
         w var7;
         if ((var7 = (w)var1).size() != this.size()) {
            return false;
         } else {
            try {
               A_ref var2 = this.iterator();
