...
import gnu.trove.ba.S_ref;
import gnu.trove.c_ref.V_ref;
import gnu.trove.e_ref.T_ref;
import gnu.trove.e_ref.aa;
import gnu.trove.e_ref.h;
import gnu.trove.f_ref.f;
import gnu.trove.map.O_ref;
...
public class TLongByteHashMap extends S_ref implements O_ref, Externalizable {
   ...
   public TLongByteHashMap(O_ref var1) {
      super(var1.size());
   ...
   public void putAll(O_ref var1) {
      this.ensureCapacity(var1.size());
      V_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(T_ref var1) {
      byte[] var2 = this._states;
      long[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(T_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      long[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof O_ref)) {
         return false;
      } else {
         O_ref var10;
         if ((var10 = (O_ref)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TLongByteHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static long access$0(TLongByteHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TLongByteHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static byte access$2(TLongByteHashMap var0) {
