...
public class TByteCharHashMap extends b implements gnu.trove.map.b, Externalizable {
   ...
   public TByteCharHashMap(gnu.trove.map.b var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.b var1) {
      this.ensureCapacity(var1.size());
      c var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.b var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      char[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.b var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.b)) {
         return false;
      } else {
         gnu.trove.map.b var9;
         if ((var9 = (gnu.trove.map.b)var1).size() != this.size()) {
            return false;
         } else {
            char[] var2 = this._values;
            byte[] var3 = this._states;
