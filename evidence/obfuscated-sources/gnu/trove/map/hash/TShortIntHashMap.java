...
public class TShortIntHashMap extends ah implements ai, Externalizable {
   ...
   public TShortIntHashMap(ai var1) {
      super(var1.size());
   ...
   public void putAll(ai var1) {
      this.ensureCapacity(var1.size());
      aq var2 = var1.iterator();
   ...
   public boolean forEachEntry(ao var1) {
      byte[] var2 = this._states;
      short[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(ao var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ai)) {
         ...
         ai var9;
         if ((var9 = (ai)var1).size() != this.size()) {
            return false;
         } else {
            int[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortIntHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static short access$0(TShortIntHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TShortIntHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static int access$2(TShortIntHashMap var0) {
