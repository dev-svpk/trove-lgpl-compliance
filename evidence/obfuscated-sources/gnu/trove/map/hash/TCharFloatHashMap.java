...
import gnu.trove.ba.l;
import gnu.trove.c_ref.n;
...
public class TCharFloatHashMap extends l implements gnu.trove.map.l, Externalizable {
   ...
   public TCharFloatHashMap(gnu.trove.map.l var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.l var1) {
      this.ensureCapacity(var1.size());
      n var2 = var1.iterator();
   ...
   public boolean forEachEntry(m var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(m var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.l)) {
         return false;
      } else {
         gnu.trove.map.l var9;
         if ((var9 = (gnu.trove.map.l)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharFloatHashMap$1(this, var1));
      var1.append("}");
   ...
   public void writeExternal(ObjectOutput var1) {
       try {
           ...
           Logger.getLogger(TCharFloatHashMap.class.getName()).log(Level.SEVERE, null, ex);
       }
   ...
   // $FF: synthetic method
   static char access$0(TCharFloatHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TCharFloatHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static float access$2(TCharFloatHashMap var0) {
