...
import gnu.trove.ba.F_ref;
import gnu.trove.c_ref.I_ref;
import gnu.trove.e_ref.G_ref;
import gnu.trove.e_ref.aa;
import gnu.trove.f_ref.d;
import gnu.trove.map.D_ref;
...
public class TFloatLongHashMap extends F_ref implements D_ref, Externalizable {
   ...
   public TFloatLongHashMap(D_ref var1) {
      super(var1.size());
   ...
   public void putAll(D_ref var1) {
      this.ensureCapacity(var1.size());
      I_ref var2 = var1.iterator();
   ...
   public I_ref iterator() {
      return new TFloatLongHashMap$TFloatLongHashIterator(this, this);
   }

   public boolean forEachKey(gnu.trove.e_ref.I_ref var1) {
   ...
   public boolean forEachEntry(G_ref var1) {
      byte[] var2 = this._states;
      float[] var3 = this._set;
      long[] var4 = this._values;
   ...
   public boolean retainEntries(G_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof D_ref)) {
         return false;
      } else {
         D_ref var15;
         if ((var15 = (D_ref)var1).size() != this.size()) {
            return false;
         } else {
            long[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TFloatLongHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static float access$0(TFloatLongHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TFloatLongHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static long access$2(TFloatLongHashMap var0) {
