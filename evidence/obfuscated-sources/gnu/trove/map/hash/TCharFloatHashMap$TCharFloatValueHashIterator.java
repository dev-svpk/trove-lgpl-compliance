...
class TCharFloatHashMap$TCharFloatValueHashIterator extends J_ref implements H_ref {
   // $FF: synthetic field
   final TCharFloatHashMap this$0;

   TCharFloatHashMap$TCharFloatValueHashIterator(TCharFloatHashMap var1, ab var2) {
      super(var2);
      this.this$0 = var1;
   }
