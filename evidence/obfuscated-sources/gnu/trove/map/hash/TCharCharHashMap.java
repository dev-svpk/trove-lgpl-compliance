...
import gnu.trove.ba.j;
import gnu.trove.c_ref.l;
import gnu.trove.e_ref.k;
...
public class TCharCharHashMap extends j implements gnu.trove.map.j, Externalizable {
   ...
   public TCharCharHashMap(gnu.trove.map.j var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.j var1) {
      this.ensureCapacity(var1.size());
      l var2 = var1.iterator();
   ...
   public boolean forEachEntry(k var1) {
      byte[] var2 = this._states;
      char[] var3 = this._set;
      char[] var4 = this._values;
   ...
   public boolean retainEntries(k var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      char[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.j)) {
         return false;
      } else {
         gnu.trove.map.j var9;
         if ((var9 = (gnu.trove.map.j)var1).size() != this.size()) {
            return false;
         } else {
            char[] var2 = this._values;
            byte[] var3 = this._states;
