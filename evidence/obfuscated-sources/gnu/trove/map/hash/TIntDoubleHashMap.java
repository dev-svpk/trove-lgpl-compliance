...
import gnu.trove.ba.M_ref;
import gnu.trove.c_ref.N_ref;
import gnu.trove.e_ref.R_ref;
import gnu.trove.e_ref.z;
import gnu.trove.f_ref.e;
import gnu.trove.map.I_ref;
...
public class TIntDoubleHashMap extends M_ref implements I_ref, Externalizable {
   ...
   public TIntDoubleHashMap(I_ref var1) {
      super(var1.size());
   ...
   public void putAll(I_ref var1) {
      this.ensureCapacity(var1.size());
      N_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(gnu.trove.e_ref.M_ref var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      double[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.e_ref.M_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public double adjustOrPutValue(int var1, double var2, double var4) {
      ...
      if ((var1 = this.insertKey(var1)) < 0) {
         var1 = -var1 - 1;
         double[] var10000 = this._values;
         var8 = var10000[var1] += var2;
         var10 = false;
      } else {
         var8 = this._values[var1] = var4;
         var10 = true;
      }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof I_ref)) {
         return false;
      } else {
         I_ref var15;
         if ((var15 = (I_ref)var1).size() != this.size()) {
            return false;
         } else {
            double[] var2 = this._values;
            byte[] var3 = this._states;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntDoubleHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static int access$0(TIntDoubleHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TIntDoubleHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static double access$2(TIntDoubleHashMap var0) {
