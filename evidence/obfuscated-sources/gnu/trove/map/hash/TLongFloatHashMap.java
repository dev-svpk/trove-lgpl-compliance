...
import gnu.trove.ba.V_ref;
import gnu.trove.c_ref.Y_ref;
import gnu.trove.e_ref.I_ref;
import gnu.trove.e_ref.W_ref;
import gnu.trove.e_ref.aa;
import gnu.trove.f_ref.f;
import gnu.trove.map.R_ref;
...
public class TLongFloatHashMap extends V_ref implements R_ref, Externalizable {
   ...
   public TLongFloatHashMap(R_ref var1) {
      super(var1.size());
   ...
   public void putAll(R_ref var1) {
      this.ensureCapacity(var1.size());
      Y_ref var2 = var1.iterator();
   ...
   public boolean forEachEntry(W_ref var1) {
      byte[] var2 = this._states;
      long[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(W_ref var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      long[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof R_ref)) {
         return false;
      } else {
         R_ref var10;
         if ((var10 = (R_ref)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
            float var4 = this.getNoEntryValue();
            float var5 = var10.getNoEntryValue();
            int var6 = var2.length;

            while(var6-- > 0) {
               if (var3[var6] == 1) {
                  long var8 = this._set[var6];
                  float var7 = var10.get(var8);
                  float var11;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TLongFloatHashMap$1(this, var1));
      var1.append("}");
   ...
   // $FF: synthetic method
   static long access$0(TLongFloatHashMap var0) {
      return var0.no_entry_key;
   }

   // $FF: synthetic method
   static int access$1(TLongFloatHashMap var0) {
      return var0._size;
   }

   // $FF: synthetic method
   static float access$2(TLongFloatHashMap var0) {
