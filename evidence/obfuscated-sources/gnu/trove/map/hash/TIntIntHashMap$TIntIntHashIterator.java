...
import gnu.trove.c_ref.P_ref;
import java.util.ConcurrentModificationException;

class TIntIntHashMap$TIntIntHashIterator extends J_ref implements P_ref {
   // $FF: synthetic field
   final TIntIntHashMap this$0;

   TIntIntHashMap$TIntIntHashIterator(TIntIntHashMap var1, TIntIntHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
