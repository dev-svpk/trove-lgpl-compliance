...
public class TShortCharHashMap$TValueView implements TCharCollection {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TShortCharHashMap$TShortCharValueHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TShortCharHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TShortCharHashMap$TValueView$1(this, var1));
      var1.append("}");
