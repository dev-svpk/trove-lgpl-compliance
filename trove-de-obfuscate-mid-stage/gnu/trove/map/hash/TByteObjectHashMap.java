...
public class TByteObjectHashMap extends TByteHash implements TByteObjectMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TByteObjectProcedure var1) {
      byte[] var2 = this._states;
      byte[] var3 = this._set;
      Object[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TByteObjectProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      byte[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TByteObjectMap)) {
         ...
         TByteObjectMap var6;
         if ((var6 = (TByteObjectMap)var1).size() != this.size()) {
            return false;
         } else {
            try {
               TByteObjectIterator var2 = this.iterator();
