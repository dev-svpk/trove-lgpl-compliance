...
public class TCharShortHashMap extends TCharShortHash implements gnu.trove.map.TCharShortMap, Externalizable {
   ...
   public TCharShortHashMap(gnu.trove.map.TCharShortMap var1) {
      super(var1.size());
   ...
   public void putAll(gnu.trove.map.TCharShortMap var1) {
      this.ensureCapacity(var1.size());
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof gnu.trove.map.TCharShortMap)) {
         return false;
      } else {
         gnu.trove.map.TCharShortMap var9;
         if ((var9 = (gnu.trove.map.TCharShortMap)var1).size() != this.size()) {
            return false;
         } else {
            short[] var2 = this._values;
            byte[] var3 = this._states;
