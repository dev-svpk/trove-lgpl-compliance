...
class TShortFloatHashMap$TShortFloatHashIterator extends THashPrimitiveIterator implements TShortFloatIterator {
   // $FF: synthetic field
   final TShortFloatHashMap this$0;

   TShortFloatHashMap$TShortFloatHashIterator(TShortFloatHashMap var1, TShortFloatHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
