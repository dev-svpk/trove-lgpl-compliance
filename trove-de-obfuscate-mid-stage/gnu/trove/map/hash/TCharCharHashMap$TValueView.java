...
public class TCharCharHashMap$TValueView implements TCharCollection {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TCharCharHashMap$TCharCharValueHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TCharCharHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TCharCharHashMap$TValueView$1(this, var1));
      var1.append("}");
