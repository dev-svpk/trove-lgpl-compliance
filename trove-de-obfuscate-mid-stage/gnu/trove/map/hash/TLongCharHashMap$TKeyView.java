...
public class TLongCharHashMap$TKeyView implements TLongSet {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TLongCharHashMap$TLongCharKeyHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TLongCharHashMap.access$0(this.this$0);
   }

   public int size() {
      return TLongCharHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TLongCharHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(long var1) {
      return TLongCharHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TLongCharHashMap$TKeyView$1(this, var1));
      var1.append("}");
