...
public class TCharLongHashMap$TValueView implements TLongCollection {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TCharLongHashMap$TCharLongValueHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TCharLongHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TCharLongHashMap$TValueView$1(this, var1));
      var1.append("}");
