...
class TDoubleCharHashMap$TDoubleCharHashIterator extends THashPrimitiveIterator implements TDoubleCharIterator {
   // $FF: synthetic field
   final TDoubleCharHashMap this$0;

   TDoubleCharHashMap$TDoubleCharHashIterator(TDoubleCharHashMap var1, TDoubleCharHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
