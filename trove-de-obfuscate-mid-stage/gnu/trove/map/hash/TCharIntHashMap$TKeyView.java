...
public class TCharIntHashMap$TKeyView implements TCharSet {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TCharIntHashMap$TCharIntKeyHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TCharIntHashMap.access$0(this.this$0);
   }

   public int size() {
      return TCharIntHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TCharIntHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(char var1) {
      return TCharIntHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TCharIntHashMap$TKeyView$1(this, var1));
      var1.append("}");
