...
public class TIntByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TIntByteHashMap$TIntByteValueHashIterator(this.this$0, this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntByteHashMap$TValueView$1(this, var1));
      var1.append("}");
