...
class TCharFloatHashMap$TCharFloatHashIterator extends THashPrimitiveIterator implements TCharFloatIterator {
   // $FF: synthetic field
   final TCharFloatHashMap this$0;

   TCharFloatHashMap$TCharFloatHashIterator(TCharFloatHashMap var1, TCharFloatHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
