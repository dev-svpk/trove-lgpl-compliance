...
public class TDoubleIntHashMap$TValueView implements TIntCollection {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TDoubleIntHashMap$TDoubleIntValueHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TDoubleIntHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TDoubleIntHashMap$TValueView$1(this, var1));
      var1.append("}");
