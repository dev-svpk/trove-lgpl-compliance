...
public class TByteByteHashMap$TKeyView implements TByteSet {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteByteHashMap$TByteByteKeyHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteByteHashMap.access$0(this.this$0);
   }

   public int size() {
      return TByteByteHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TByteByteHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(byte var1) {
      return TByteByteHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TByteByteHashMap$TKeyView$1(this, var1));
      var1.append("}");
