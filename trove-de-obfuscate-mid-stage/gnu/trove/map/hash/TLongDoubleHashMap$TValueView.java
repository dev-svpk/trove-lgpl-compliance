...
public class TLongDoubleHashMap$TValueView implements TDoubleCollection {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TLongDoubleHashMap$TLongDoubleValueHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TLongDoubleHashMap.access$2(this.this$0);
   }
   ...
   public boolean remove(double var1) {
      ...
      } while(var4[var5] == 0L || var4[var5] == 2L || var1 != var3[var5]);
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TLongDoubleHashMap$TValueView$1(this, var1));
      var1.append("}");
