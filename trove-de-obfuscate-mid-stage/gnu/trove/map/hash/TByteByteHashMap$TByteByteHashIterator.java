...
class TByteByteHashMap$TByteByteHashIterator extends THashPrimitiveIterator implements TByteByteIterator {
   // $FF: synthetic field
   final TByteByteHashMap this$0;

   TByteByteHashMap$TByteByteHashIterator(TByteByteHashMap var1, TByteByteHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
