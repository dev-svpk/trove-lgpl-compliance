...
public class TFloatDoubleHashMap$TValueView implements TDoubleCollection {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TFloatDoubleHashMap$TFloatDoubleValueHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TFloatDoubleHashMap.access$2(this.this$0);
   }

   public int size() {
      return TFloatDoubleHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TFloatDoubleHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(double var1) {
      ...
      } while(var4[var5] == 0.0F || var4[var5] == 2.0F || var1 != var3[var5]);
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatDoubleHashMap$TValueView$1(this, var1));
      var1.append("}");
