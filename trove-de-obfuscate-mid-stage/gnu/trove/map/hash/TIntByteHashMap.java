...
public class TIntByteHashMap extends TIntByteHash implements TIntByteMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TIntByteProcedure var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      byte[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TIntByteProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntByteMap)) {
         ...
         TIntByteMap var9;
         if ((var9 = (TIntByteMap)var1).size() != this.size()) {
            return false;
         } else {
            byte[] var2 = this._values;
            byte[] var3 = this._states;
