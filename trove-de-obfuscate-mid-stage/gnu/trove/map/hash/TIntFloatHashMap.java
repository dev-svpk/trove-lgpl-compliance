...
public class TIntFloatHashMap extends TIntFloatHash implements TIntFloatMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TIntFloatProcedure var1) {
      byte[] var2 = this._states;
      int[] var3 = this._set;
      float[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TIntFloatProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      int[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntFloatMap)) {
         ...
         TIntFloatMap var9;
         if ((var9 = (TIntFloatMap)var1).size() != this.size()) {
            return false;
         } else {
            float[] var2 = this._values;
            byte[] var3 = this._states;
