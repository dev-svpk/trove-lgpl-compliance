...
public class TIntIntHashMap$TValueView implements TIntCollection {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntIntHashMap$TIntIntValueHashIterator(this.this$0, this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntIntHashMap$TValueView$1(this, var1));
      var1.append("}");
