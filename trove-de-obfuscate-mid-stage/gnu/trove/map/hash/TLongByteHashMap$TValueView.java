...
public class TLongByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TLongByteHashMap$TLongByteValueHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TLongByteHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TLongByteHashMap$TValueView$1(this, var1));
      var1.append("}");
