...
public class TCharLongHashMap$TKeyView implements TCharSet {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TCharLongHashMap$TCharLongKeyHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TCharLongHashMap.access$0(this.this$0);
   }

   public int size() {
      return TCharLongHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TCharLongHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(char var1) {
      return TCharLongHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TCharLongHashMap$TKeyView$1(this, var1));
      var1.append("}");
