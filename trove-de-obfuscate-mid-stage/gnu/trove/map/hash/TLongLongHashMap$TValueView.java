...
public class TLongLongHashMap$TValueView implements TLongCollection {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TLongLongHashMap$TLongLongValueHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TLongLongHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TLongLongHashMap$TValueView$1(this, var1));
      var1.append("}");
