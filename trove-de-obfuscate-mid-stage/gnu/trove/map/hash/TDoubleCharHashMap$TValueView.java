...
public class TDoubleCharHashMap$TValueView implements TCharCollection {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TDoubleCharHashMap$TDoubleCharValueHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TDoubleCharHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TDoubleCharHashMap$TValueView$1(this, var1));
      var1.append("}");
