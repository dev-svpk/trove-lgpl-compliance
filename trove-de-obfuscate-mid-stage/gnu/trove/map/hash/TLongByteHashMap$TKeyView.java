...
public class TLongByteHashMap$TKeyView implements TLongSet {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TLongByteHashMap$TLongByteKeyHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TLongByteHashMap.access$0(this.this$0);
   }

   public int size() {
      return TLongByteHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TLongByteHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(long var1) {
      return TLongByteHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TLongByteHashMap$TKeyView$1(this, var1));
      var1.append("}");
