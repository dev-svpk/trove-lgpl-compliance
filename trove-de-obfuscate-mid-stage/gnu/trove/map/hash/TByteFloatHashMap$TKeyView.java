...
public class TByteFloatHashMap$TKeyView implements TByteSet {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteFloatHashMap$TByteFloatKeyHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteFloatHashMap.access$0(this.this$0);
   }

   public int size() {
      return TByteFloatHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TByteFloatHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(byte var1) {
      return TByteFloatHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TByteFloatHashMap$TKeyView$1(this, var1));
      var1.append("}");
