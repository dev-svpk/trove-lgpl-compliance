...
public class TDoubleByteHashMap$TKeyView implements TDoubleSet {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleByteHashMap$TDoubleByteKeyHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleByteHashMap.access$0(this.this$0);
   }

   public int size() {
      return TDoubleByteHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TDoubleByteHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(double var1) {
      return TDoubleByteHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TDoubleByteHashMap$TKeyView$1(this, var1));
      var1.append("}");
