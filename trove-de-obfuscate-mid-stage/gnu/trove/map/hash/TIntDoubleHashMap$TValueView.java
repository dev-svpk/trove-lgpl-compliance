...
public class TIntDoubleHashMap$TValueView implements TDoubleCollection {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TIntDoubleHashMap$TIntDoubleValueHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TIntDoubleHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntDoubleHashMap$TValueView$1(this, var1));
      var1.append("}");
