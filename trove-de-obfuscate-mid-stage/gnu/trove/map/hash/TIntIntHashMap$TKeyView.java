...
public class TIntIntHashMap$TKeyView implements TIntSet {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntIntHashMap$TIntIntKeyHashIterator(this.this$0, this.this$0);
   }
   ...
   public boolean remove(int var1) {
      return TIntIntHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TIntIntHashMap$TKeyView$1(this, var1));
      var1.append("}");
