...
class TShortIntHashMap$TShortIntHashIterator extends THashPrimitiveIterator implements TShortIntIterator {
   // $FF: synthetic field
   final TShortIntHashMap this$0;

   TShortIntHashMap$TShortIntHashIterator(TShortIntHashMap var1, TShortIntHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
