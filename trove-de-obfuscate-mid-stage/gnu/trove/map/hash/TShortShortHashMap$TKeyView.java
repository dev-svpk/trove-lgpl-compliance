...
public class TShortShortHashMap$TKeyView implements TShortSet {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortShortHashMap$TShortShortKeyHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortShortHashMap.access$0(this.this$0);
   }

   public int size() {
      return TShortShortHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TShortShortHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(short var1) {
      return TShortShortHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TShortShortHashMap$TKeyView$1(this, var1));
      var1.append("}");
