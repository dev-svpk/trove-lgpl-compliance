...
public class TDoubleShortHashMap$TValueView implements TShortCollection {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TDoubleShortHashMap$TDoubleShortValueHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TDoubleShortHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TDoubleShortHashMap$TValueView$1(this, var1));
      var1.append("}");
