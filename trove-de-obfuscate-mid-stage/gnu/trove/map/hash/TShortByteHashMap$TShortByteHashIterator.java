...
class TShortByteHashMap$TShortByteHashIterator extends THashPrimitiveIterator implements TShortByteIterator {
   // $FF: synthetic field
   final TShortByteHashMap this$0;

   TShortByteHashMap$TShortByteHashIterator(TShortByteHashMap var1, TShortByteHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
