...
public class TLongDoubleHashMap$TKeyView implements TLongSet {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TLongDoubleHashMap$TLongDoubleKeyHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TLongDoubleHashMap.access$0(this.this$0);
   }

   public int size() {
      return TLongDoubleHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TLongDoubleHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(long var1) {
      return TLongDoubleHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public boolean containsAll(gnu.trove.TLongCollection var1) {
   ...
   public boolean addAll(gnu.trove.TLongCollection var1) {
      throw new UnsupportedOperationException();
   }
   ...
   public boolean retainAll(gnu.trove.TLongCollection var1) {
      if (this == var1) {
         return false;
      } else {
         boolean var2 = false;
   ...
   public boolean removeAll(gnu.trove.TLongCollection var1) {
      if (this == var1) {
         this.clear();
         return true;
      } else {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TLongSet)) {
         ...
         TLongSet var3;
         if ((var3 = (TLongSet)var1).size() != this.size()) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TLongDoubleHashMap$TKeyView$1(this, var1));
      var1.append("}");
