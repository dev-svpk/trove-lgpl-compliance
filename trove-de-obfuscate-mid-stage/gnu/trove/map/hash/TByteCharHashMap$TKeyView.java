...
public class TByteCharHashMap$TKeyView implements TByteSet {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteCharHashMap$TByteCharKeyHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteCharHashMap.access$0(this.this$0);
   }
   ...
   public boolean remove(byte var1) {
      return TByteCharHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TByteCharHashMap$TKeyView$1(this, var1));
      var1.append("}");
