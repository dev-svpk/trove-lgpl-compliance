...
public class TCharIntHashMap$TValueView implements TIntCollection {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TCharIntHashMap$TCharIntValueHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TCharIntHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TCharIntHashMap$TValueView$1(this, var1));
      var1.append("}");
