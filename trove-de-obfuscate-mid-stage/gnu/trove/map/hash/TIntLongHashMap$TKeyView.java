...
public class TIntLongHashMap$TKeyView implements TIntSet {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntLongHashMap$TIntLongKeyHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TIntLongHashMap.access$0(this.this$0);
   }

   public int size() {
      return TIntLongHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TIntLongHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(int var1) {
      return TIntLongHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TIntLongHashMap$TKeyView$1(this, var1));
      var1.append("}");
