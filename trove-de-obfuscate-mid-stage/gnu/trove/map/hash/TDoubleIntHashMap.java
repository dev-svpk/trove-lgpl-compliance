...
public class TDoubleIntHashMap extends TDoubleIntHash implements TDoubleIntMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TDoubleIntProcedure var1) {
      byte[] var2 = this._states;
      double[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TDoubleIntProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TDoubleIntMap)) {
         ...
         TDoubleIntMap var10;
         if ((var10 = (TDoubleIntMap)var1).size() != this.size()) {
            return false;
         } else {
            int[] var2 = this._values;
            byte[] var3 = this._states;
