...
public class TLongIntHashMap extends TLongIntHash implements TLongIntMap, Externalizable {
   ...
   public boolean forEachEntry(gnu.trove.procedure.TLongIntProcedure var1) {
      byte[] var2 = this._states;
      long[] var3 = this._set;
      int[] var4 = this._values;
   ...
   public boolean retainEntries(gnu.trove.procedure.TLongIntProcedure var1) {
      boolean var2 = false;
      byte[] var3 = this._states;
      long[] var4 = this._set;
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TLongIntMap)) {
         ...
         TLongIntMap var10;
         if ((var10 = (TLongIntMap)var1).size() != this.size()) {
            return false;
         } else {
            int[] var2 = this._values;
            byte[] var3 = this._states;
