...
public class TFloatIntHashMap$TValueView implements TIntCollection {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TFloatIntHashMap$TFloatIntValueHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TFloatIntHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatIntHashMap$TValueView$1(this, var1));
      var1.append("}");
