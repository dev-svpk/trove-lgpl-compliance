...
public class TShortShortHashMap$TValueView implements TShortCollection {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortShortHashMap$TShortShortValueHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortShortHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TShortShortHashMap$TValueView$1(this, var1));
      var1.append("}");
