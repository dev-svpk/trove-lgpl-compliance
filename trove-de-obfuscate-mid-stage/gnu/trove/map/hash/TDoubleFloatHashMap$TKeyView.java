...
public class TDoubleFloatHashMap$TKeyView implements TDoubleSet {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TDoubleFloatHashMap$TDoubleFloatKeyHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TDoubleFloatHashMap.access$0(this.this$0);
   }

   public int size() {
      return TDoubleFloatHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TDoubleFloatHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(double var1) {
      return TDoubleFloatHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TDoubleFloatHashMap$TKeyView$1(this, var1));
      var1.append("}");
