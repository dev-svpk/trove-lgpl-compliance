...
public class TCharShortHashMap$TValueView implements TShortCollection {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TCharShortHashMap$TCharShortValueHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TCharShortHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TCharShortHashMap$TValueView$1(this, var1));
      var1.append("}");
