...
public class TCharDoubleHashMap$TKeyView implements TCharSet {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TCharDoubleHashMap$TCharDoubleKeyHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TCharDoubleHashMap.access$0(this.this$0);
   }

   public int size() {
      return TCharDoubleHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TCharDoubleHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(char var1) {
      return TCharDoubleHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public boolean containsAll(gnu.trove.TCharCollection var1) {
      TIterator var2 = var1.iterator();

      while(var2.hasNext()) {
         if (!this.this$0.containsKey(var2.nextChar())) {
            return false;
         }
      }
   ...
   public boolean addAll(gnu.trove.TCharCollection var1) {
      throw new UnsupportedOperationException();
   }
   ...
   public boolean retainAll(gnu.trove.TCharCollection var1) {
      if (this == var1) {
         return false;
      } else {
         boolean var2 = false;
   ...
   public boolean removeAll(gnu.trove.TCharCollection var1) {
      if (this == var1) {
         this.clear();
         return true;
      } else {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharSet)) {
         ...
         TCharSet var3;
         if ((var3 = (TCharSet)var1).size() != this.size()) {
            return false;
         } else {
   ...
   public int hashCode() {
      ...
      while(var2-- > 0) {
         if (this.this$0._states[var2] == 1) {
            var1 += gnu.trove.impl.HashFunctions.hash(this.this$0._set[var2]);
         }
      }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TCharDoubleHashMap$TKeyView$1(this, var1));
      var1.append("}");
