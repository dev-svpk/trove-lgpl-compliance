...
public class TCharByteHashMap$TKeyView implements TCharSet {
   // $FF: synthetic field
   ...
   public TCharIterator iterator() {
      return new TCharByteHashMap$TCharByteKeyHashIterator(this.this$0, this.this$0);
   }

   public char getNoEntryValue() {
      return TCharByteHashMap.access$0(this.this$0);
   }

   public int size() {
      return TCharByteHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TCharByteHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(char var1) {
      return TCharByteHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TCharByteHashMap$TKeyView$1(this, var1));
      var1.append("}");
