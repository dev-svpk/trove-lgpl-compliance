...
public class TCharByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TCharByteHashMap$TCharByteValueHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TCharByteHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TCharByteHashMap$TValueView$1(this, var1));
      var1.append("}");
