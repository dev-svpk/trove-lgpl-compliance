...
public class TShortByteHashMap$TKeyView implements TShortSet {
   // $FF: synthetic field
   ...
   public TShortIterator iterator() {
      return new TShortByteHashMap$TShortByteKeyHashIterator(this.this$0, this.this$0);
   }

   public short getNoEntryValue() {
      return TShortByteHashMap.access$0(this.this$0);
   }

   public int size() {
      return TShortByteHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TShortByteHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(short var1) {
      return TShortByteHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TShortByteHashMap$TKeyView$1(this, var1));
      var1.append("}");
