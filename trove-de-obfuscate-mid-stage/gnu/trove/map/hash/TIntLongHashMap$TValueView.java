...
public class TIntLongHashMap$TValueView implements TLongCollection {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TIntLongHashMap$TIntLongValueHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TIntLongHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntLongHashMap$TValueView$1(this, var1));
      var1.append("}");
