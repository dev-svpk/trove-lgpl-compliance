...
public class TIntCharHashMap$TKeyView implements TIntSet {
   // $FF: synthetic field
   ...
   public TIntIterator iterator() {
      return new TIntCharHashMap$TIntCharKeyHashIterator(this.this$0, this.this$0);
   }

   public int getNoEntryValue() {
      return TIntCharHashMap.access$0(this.this$0);
   }

   public int size() {
      return TIntCharHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TIntCharHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(int var1) {
      return TIntCharHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TIntCharHashMap$TKeyView$1(this, var1));
      var1.append("}");
