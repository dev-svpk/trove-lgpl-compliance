...
public class TByteByteHashMap$TValueView implements TByteCollection {
   // $FF: synthetic field
   ...
   public TByteIterator iterator() {
      return new TByteByteHashMap$TByteByteValueHashIterator(this.this$0, this.this$0);
   }

   public byte getNoEntryValue() {
      return TByteByteHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TByteByteHashMap$TValueView$1(this, var1));
      var1.append("}");
