...
class TByteObjectHashMap$ValueView$TByteObjectValueHashIterator extends THashPrimitiveIterator implements Iterator {
   protected final TByteObjectHashMap _map;
   // $FF: synthetic field
   final TByteObjectHashMap$ValueView this$1;

   public TByteObjectHashMap$ValueView$TByteObjectValueHashIterator(TByteObjectHashMap$ValueView var1, TByteObjectHashMap var2) {
      super(var2);
      this.this$1 = var1;
      this._map = var2;
   }
   ...
   protected Object objectAtIndex(int var1) {
      byte[] var2 = TByteObjectHashMap$ValueView.access$0(this.this$1)._states;
