...
public class TFloatLongHashMap$TValueView implements TLongCollection {
   // $FF: synthetic field
   ...
   public TLongIterator iterator() {
      return new TFloatLongHashMap$TFloatLongValueHashIterator(this.this$0, this.this$0);
   }

   public long getNoEntryValue() {
      return TFloatLongHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TFloatLongHashMap$TValueView$1(this, var1));
      var1.append("}");
