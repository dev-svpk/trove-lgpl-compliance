...
public class TFloatFloatHashMap$TKeyView implements TFloatSet {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TFloatFloatHashMap$TFloatFloatKeyHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TFloatFloatHashMap.access$0(this.this$0);
   }

   public int size() {
      return TFloatFloatHashMap.access$1(this.this$0);
   }

   public boolean isEmpty() {
      return TFloatFloatHashMap.access$1(this.this$0) == 0;
   }
   ...
   public boolean remove(float var1) {
      return TFloatFloatHashMap.access$2(this.this$0) != this.this$0.remove(var1);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachKey(new TFloatFloatHashMap$TKeyView$1(this, var1));
      var1.append("}");
