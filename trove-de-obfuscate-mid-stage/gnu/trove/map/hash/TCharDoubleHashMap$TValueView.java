...
public class TCharDoubleHashMap$TValueView implements TDoubleCollection {
   // $FF: synthetic field
   ...
   public TDoubleIterator iterator() {
      return new TCharDoubleHashMap$TCharDoubleValueHashIterator(this.this$0, this.this$0);
   }

   public double getNoEntryValue() {
      return TCharDoubleHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TCharDoubleHashMap$TValueView$1(this, var1));
      var1.append("}");
