...
class TIntByteHashMap$TIntByteHashIterator extends THashPrimitiveIterator implements TIntByteIterator {
   // $FF: synthetic field
   final TIntByteHashMap this$0;

   TIntByteHashMap$TIntByteHashIterator(TIntByteHashMap var1, TIntByteHashMap var2) {
      super(var2);
      this.this$0 = var1;
   }
