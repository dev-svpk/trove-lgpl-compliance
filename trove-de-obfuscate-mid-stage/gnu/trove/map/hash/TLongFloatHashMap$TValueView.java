...
public class TLongFloatHashMap$TValueView implements TFloatCollection {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TLongFloatHashMap$TLongFloatValueHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TLongFloatHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TLongFloatHashMap$TValueView$1(this, var1));
      var1.append("}");
