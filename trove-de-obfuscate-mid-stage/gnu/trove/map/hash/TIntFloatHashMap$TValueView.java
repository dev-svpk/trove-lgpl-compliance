...
public class TIntFloatHashMap$TValueView implements TFloatCollection {
   // $FF: synthetic field
   ...
   public TFloatIterator iterator() {
      return new TIntFloatHashMap$TIntFloatValueHashIterator(this.this$0, this.this$0);
   }

   public float getNoEntryValue() {
      return TIntFloatHashMap.access$2(this.this$0);
   }
   ...
   public String toString() {
      ...
      this.this$0.forEachValue(new TIntFloatHashMap$TValueView$1(this, var1));
      var1.append("}");
