...
final class TCharArrayList$TCharArrayIterator implements TCharIterator {
   private int _cursor;
   private int _lastReturned;
   // $FF: synthetic field
   private TCharArrayList this$0;

   TCharArrayList$TCharArrayIterator(TCharArrayList var1, int var2) {
      super();
      this.this$0 = var1;
      this._cursor = 0;
   ...
   public final char next() {
      try {
         char var1 = this.this$0.get(this._cursor);
