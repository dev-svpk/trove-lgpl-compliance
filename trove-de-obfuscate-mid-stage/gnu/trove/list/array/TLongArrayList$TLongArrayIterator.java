...
final class TLongArrayList$TLongArrayIterator implements TLongIterator {
   private int _cursor;
   private int _lastReturned;
   // $FF: synthetic field
   private TLongArrayList this$0;

   TLongArrayList$TLongArrayIterator(TLongArrayList var1, int var2) {
      super();
      this.this$0 = var1;
      this._cursor = 0;
   ...
   public final long next() {
      try {
         long var1 = this.this$0.get(this._cursor);
